...
## Last modified on 17.07.2019 to fix bug on division by zero if some length of sequences between 20 and 40 (the min and max default values) not present in the bam file.  
